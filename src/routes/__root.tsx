...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ContaVE — Contabilidad SENIAT" },
      { property: "og:description", content: "Libros de Ventas y Compras, retenciones IVA/ISLR y facturación electrónica multi-empresa." },

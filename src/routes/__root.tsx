...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ContaVE — Sistema Contable  " },
      { name: "description", content: "Plataforma contable multi-empresa para : libros de IVA, retenciones y facturación electrónica conforme a las normativas del ." },
      { name: "author", content: "ContaVE" },
      { property: "og:title", content: "ContaVE — Sistema Contable  " },
      { property: "og:description", content: "Plataforma contable multi-empresa para : libros de IVA, retenciones y facturación electrónica conforme a las normativas del ." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "ContaVE — Sistema Contable  " },
      { name: "twitter:description", content: "Plataforma contable multi-empresa para : libros de IVA, retenciones y facturación electrónica conforme a las normativas del ." },
